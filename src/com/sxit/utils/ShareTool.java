...
public class ShareTool {
	...
	public static ShareTool getInstance(Context context, Activity activity, String _title, String _content, String _url, String _headpic) {
//		if (share == null) {
			share = new ShareTool(context, activity, _title, _content, _url,_headpic);
//		}
		return share;
	}
...
//		return share;
//	}
	public ShareTool(Context context, Activity activity, String _title, String _content, String _url, String _headpic) {
		...
		if(HEADPIC!=null){
			urlImage = new UMImage(context, SOAP_UTILS.HTTP_HEAD_PATH + HEADPIC);
		}else{
...
//		mController.getConfig().removePlatform(SHARE_MEDIA.RENREN, SHARE_MEDIA.DOUBAN, SHARE_MEDIA.SINA);
		mController.getConfig().removePlatform(SHARE_MEDIA.RENREN, SHARE_MEDIA.DOUBAN, SHARE_MEDIA.QZONE, SHARE_MEDIA.SMS, SHARE_MEDIA.QQ);
		// 添加QQ、QZone平台
//		addQQQZonePlatform();
		// 添加微信、微信朋友圈平台
		addWXPlatform();
	...
	private void addWXPlatform() {
		...
		String appSecret = WXEntryActivity.AppSecret;
		// 添加微信平台
