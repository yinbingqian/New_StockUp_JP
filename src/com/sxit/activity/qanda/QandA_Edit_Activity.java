 ...
 */
public class QandA_Edit_Activity extends BaseActivity {
	Context context;
	...
	AutoCompleteTextView edit_title;
	Button bt_send;
	TextView tv_tagname;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qanda_edit);
...
//		soapService.questionSubmit(property_va);
		...
		Object[] property_va = { user.getid(), edit_title.getText().toString(), edit_content.getText().toString(), tag_value, img1_name, img2_name };
		new questionSubmitPostTask().execute(property_nm, property_va);
	}
	
	class questionSubmitPostTask extends AsyncTask<Object, Object, Object> {
        @Override
        ...
        protected Object doInBackground(Object... params) {
            System.out.println(">>>>>");
            Object res_obj = (Object) HttpPostService.data(SOAP_UTILS.METHOD.QUESTIONSUBMITPOST, (String[]) params[0],(Object[]) params[1]);
            return res_obj;
        }
        ...
        protected void onPostExecute(Object result) {
            ...
            try {
				...
				JSONObject json_obj = new JSONObject(json_res.get("QuestionSubmitPostResult").toString());
	...
	private void initView() {
		...
		edit_title = (AutoCompleteTextView) findViewById(R.id.title);
	...
	public void onClick(View v) {
		...
		case R.id.layout_type:
			...
			intent_type.setClass(QandA_Edit_Activity.this, QandA_Type_Activity.class);
	...
	public void onEvent(SoapRes obj) {
		super.onEvent(obj);
		if (obj.getCode().equals(SOAP_UTILS.METHOD.QUESTIONSUBMIT)) {
        ...
        protected void onPostExecute(Object result) {
            ...
            try {
				...
				if(json_obj.get("Result").toString().equals("success")){
					...
					Toast.makeText(QandA_Edit_Activity.this, "图像上传成功", Toast.LENGTH_SHORT).show();
				}else if(json_obj.get("Result").toString().equals("error")){
					Toast.makeText(QandA_Edit_Activity.this, json_obj.get("Message").toString(), Toast.LENGTH_SHORT).show();
				}
			} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
