...
public class AnswerQuestion_Adapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (anwser.getMsg_direction() == Anwser.MESSAGE_O) {
			...
			Instance.imageLoader.displayImage(list.get(position).getUser_img(), holder.img_head_left,
					Instance.user_options);
			if (list.get(position).getContent_img() != null
					&& !list.get(position).getContent_img().equals(SOAP_UTILS.HEADER_URL + "anyType{}")) {
				Instance.imageLoader.displayImage(list.get(position).getContent_img(), holder.img_content_url_left,
						Instance.new_s_options);
			} else {
			...
			Instance.imageLoader.displayImage(list.get(position).getUser_img(), holder.img_head_right,
					Instance.user_options);
			if (list.get(position).getContent_img() != null
					&& !list.get(position).getContent_img().equals(SOAP_UTILS.HEADER_URL + "anyType{}")) {
				Instance.imageLoader.displayImage(list.get(position).getContent_img(), holder.img_content_url_right,
						Instance.new_s_options);
			} else {
