...
public class MainTabHostActivity extends TabHostAbstractActivity {
	...
	protected void prepare() {
		TabHostItem info = new TabHostItem(getString(R.string.tabHost_frist), // title
				...
				new Intent(this, HomePageActivity.class)); // intent

		TabHostItem analyst = new TabHostItem(getString(R.string.tabHost_second), R.drawable.tab_icon_2_u,
				R.drawable.maintab_toolbar_bg, new Intent(this, Smarter_Activity.class));
