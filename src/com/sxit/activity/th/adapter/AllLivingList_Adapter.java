...
public class AllLivingList_Adapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.item_allliving, null);
			viewHolder = new ViewHolder();
			viewHolder.name = (TextView) convertView.findViewById(R.id.expert_name);
			viewHolder.attention_tv = (TextView) convertView.findViewById(R.id.attention_tv);
			viewHolder.zbj_text = (TextView) convertView.findViewById(R.id.zbj_text);
			viewHolder.intro = (TextView) convertView.findViewById(R.id.expert_content);
			viewHolder.head_img = (ImageView) convertView.findViewById(R.id.expert_headpic);
			viewHolder.livecount = (TextView) convertView.findViewById(R.id.expert_LiveCount);
			viewHolder.rewardmark = (TextView) convertView.findViewById(R.id.expert_rewardmark);
			viewHolder.watching_text = (TextView) convertView.findViewById(R.id.watching_text);
			viewHolder.living_tv = (TextView) convertView.findViewById(R.id.living_tv);
		...
		String headPath = SOAP_UTILS.HTTP_HEAD_PATH + list.get(position).getUserHeadpic();
		Instance.imageLoader.displayImage(headPath, viewHolder.head_img, Instance.user_s_options);
		...
		viewHolder.attention_tv
				.setOnClickListener(new ButtonListener(position, LiveUserId, UserId, type, viewHolder.attention_tv));
		...
		// viewHolder.watching_text.setOnClickListener(new
		// ButtonListener(position, LiveUserId,
	...
	class ButtonListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			// context.getSharedPreferences("live",Context.MODE_PRIVATE); //
			// 私有数据 category是新建的表名
