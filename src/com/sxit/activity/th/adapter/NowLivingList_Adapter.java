 ...
 */
public class NowLivingList_Adapter extends BaseAdapter {
	private Context context;
	private List<NowLiving> list;
	...
	public NowLivingList_Adapter(Context context, List<NowLiving> list,String UserId) {
