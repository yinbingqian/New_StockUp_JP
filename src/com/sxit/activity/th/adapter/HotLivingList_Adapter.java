 ...
 */
public class HotLivingList_Adapter extends BaseAdapter {
	private Context context;
	private List<HotLiving> list;
	...
	public HotLivingList_Adapter(Context context, List<HotLiving> list,String UserId) {
