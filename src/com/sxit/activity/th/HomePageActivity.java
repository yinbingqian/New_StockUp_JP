	...
	public void onEvent(SoapRes obj) {
		...
		if (obj.getCode().equals(SOAP_UTILS.METHOD.GETLIST)) {
			...
			if(living_list.size()>0){
				...
				list1_watching_text.setText(living_list.get(0).getLiveCount() + "人正在看");
				String livings1 = living_list.get(0).getLivings();
			...
			if(living_list.size()>1){
				...
				list2_watching_text.setText(living_list.get(1).getLiveCount() + "人正在看");
				String livings2 = living_list.get(1).getLivings();
			...
			if(living_list.size()>2){
				...
				list3_watching_text.setText(living_list.get(2).getLiveCount() + "人正在看");
				String livings3 = living_list.get(2).getLivings();
			...
			if(living_list.size()>3){
				...
				list4_watching_text.setText(living_list.get(3).getLiveCount() + "人正在看");
				String livings4 = living_list.get(3).getLivings();
