...
public class NewsInfo_Activity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent = getIntent();
		newsList = (HomePageNews) intent.getSerializableExtra("finnewslist");
		initView();
		setListeners();
...
//		soapService.getNewsContent(property_va);
	...
	public void setUI() {
		webView.loadDataWithBaseURL(null, SOAP_UTILS.HTTP_NEWSINFO_PATH + newsList.getId(), "text/html", "utf-8", null);
	}
