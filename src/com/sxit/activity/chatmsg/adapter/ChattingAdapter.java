...
public class ChattingAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null
				|| (holder = (ViewHolder) convertView.getTag()).direction != message.getMsg_direction()) {
		...
		if (message.getMsg_type() == 0) {
			...
			// FaceConversionUtil.getInstace().getExpressionString(context,
			// message.getContent());
			...
			Instance.imageLoader.displayImage(SOAP_UTILS.PIC_YANBAO + message.getContent3_img(), holder.xwivImg,
					Instance.new_s_options);
		}
//		Instance.imageLoader.displayImage(SOAP_UTILS.HEADER_URL + message.getUserinfo().getUserheader(),
//				holder.ivHeader, Instance.user_options);
