...
public class PublishMsg_Acitivty extends BaseActivity {
	...
	public void onClick(View v) {
		...
		case R.id.bt_send:
			...
			String[] property_va = new String[] { getLoginUser().getUserid(), actv_title.getText().toString().trim(),
					actv_abstract.getText().toString().trim(), actv_content.getText().toString().trim(), "0", "",
					image };
						...
						.setItems(new String[] { "相机", "相册" }, new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								if (which == 0) {
									...
									// 100);
									intent.setClass(PublishMsg_Acitivty.this, ImageActivity.class);
