...
//		dbh.setAMsgReaded(getLoginUser().getUserid(), userInfo.getUserid());
		...
		ca = new com.sxit.activity.adviser.chatmsg.adapter.ChattingAdapter(Chat_Activity.this, messages,
				getLoginUser());
...
//			Object[] property_va = { getLoginUser().getUserid(), userInfo.getUserid(), content, content, content, 1, 1,
//					2 };
