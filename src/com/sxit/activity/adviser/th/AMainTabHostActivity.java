...
public class AMainTabHostActivity extends TabHostAbstractActivity {
	...
	protected void prepare() {
		...
		TabHostItem analyst = new TabHostItem(getString(R.string.tabHost_second_a), R.drawable.tab_icon_2_u,
				R.drawable.maintab_toolbar_bg, new Intent(this, PublishMsgList_Activity.class));

		TabHostItem ask = new TabHostItem(getString(R.string.tabHost_thrid_a), R.drawable.tab_icon_3_u,
				R.drawable.maintab_toolbar_bg, new Intent(this, QuestionList_Activity.class));

		TabHostItem myzone = new TabHostItem(getString(R.string.tabHost_fourth_a), R.drawable.tab_icon_4_u,
				R.drawable.maintab_toolbar_bg, new Intent(this, MyZone_Activity.class));
